...
public class mouseOn : MonoBehaviour
{
    ...
    private GameObject mouseOn1; //이벤트 조건별 발생하는 이펙트UI
    private Text symbol;
    ...
    void Start()
    {
        ...
        mouseOn1 = GameObject.Find("Canvas").transform.Find("mouseOn").gameObject;
    ...
    void FixedUpdate()//마우스 이동할 때 말풍선 위치를 갱신시킴
    {
        if (OnMouse)
        {
            ...
            mouseOn1.transform.position = new Vector3(wantedPos.x + 20f, wantedPos.y + 375f, wantedPos.z); //말풍선 위치 변경
        }
    }
