...
public class LoadControl : MonoBehaviour
{
    ...
    //사용하는 주식의 종목코드 배열
    List<string> codeList = new List<string>() { "MSFT"  };
    ...
    //api 키 정보들
    string yahooApiKey = "bd2bc7360bmsha9dc79919d1c7e9p1641b7jsnb4bd1c60dbe6";
    string youtubeApiKey = "AIzaSyAuAYznsu0YJDB2Pbv3_ukCJwtGDZCHnNM";
