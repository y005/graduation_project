...
namespace DigitalRuby.RainMaker
{
    ...
    {   
        ...
        private void settingStockInfo(string code)
        {
            ...
            string marketcap = "";
            if(tmp >= 1000000000000) { marketcap = tmp / 1000000000000 + " T"; } //trillion
            else if(tmp >= 100000000000) { marketcap = tmp / 100000000000 + " B"; } //billion
            else { marketcap = tmp + "";  } //대부분 T, B인 듯. 그 아래로 표기한 것 없는 것 같지만 있다면 수정
